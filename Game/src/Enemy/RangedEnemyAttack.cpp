...
namespace Game
{
    ...
    void RangedEnemyAttack::EnterAttack(EnemyController& controller)
    {
    ...
    void RangedEnemyAttack::StartAttack(EnemyController& controller)
    {
        ...
        for (const auto& direction : directions)
        {
            ...
            ObjectPoolManager::GetInstance().GetPool("Thron", position + direction * distance, rotation, Vector3(0.1f, 0.1f, 0.2f));
        }
    }
}